\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{Tensor Networks on Qiskit}
...
us represent and manipulate multi-dimensional data.
    ...
    \begin{longtable}[]{@{}lll@{}}
\toprule
A vector & A matrix & A 3D Tensor\tabularnewline
\midrule
\endhead
\includegraphics{images/tensor_vector.png} &
\includegraphics{images/tensor_matrix.png} &
\includegraphics{images/tensor_3d.png}\tabularnewline
\bottomrule
\end{longtable}
...
for their discriminative model.
    ...
    \begin{longtable}[]{@{}ll@{}}
\toprule
General Tree Tensor Network & Special TTN\tabularnewline
\midrule
\endhead
\includegraphics[width=0.5\textwidth]{./images/ttn_model.png} &
\includegraphics[width=0.5\textwidth]{./images/mps_model.png}\tabularnewline
\bottomrule
\end{longtable}
...
\item
  ...
  \item
    ...
    with \(L(\Lambda)\) as defined in \(\eqref{eq:loss_equation}\)
  \item
...
\subsubsection{The networks\ldots{}}\label{the-networks}}
    ...
    \begin{longtable}[]{@{}ll@{}}
\toprule
The base model & The efficient model\tabularnewline
\midrule
\endhead
\includegraphics[width=0.4\textwidth]{../circuits/circuit_normal_4x4.png} &
\includegraphics[width=0.6\textwidth]{../circuits/circuit_efficient_4x4.png}\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
Efficient Circuit on an image 4x4 & Efficient Circuit on an image
8x8\tabularnewline
\midrule
\endhead
\includegraphics[width=0.5\textwidth]{../results/efficient/circuit_efficient_accuracy_4x4.png}
&
\includegraphics[width=0.5\textwidth]{../results/efficient/circuit_efficient_accuracy_8x8.png}\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
\includegraphics[width=0.5\textwidth]{../results/efficient/circuit_efficient_loss_4x4.png} &
\includegraphics[width=0.5\textwidth]{../results/efficient/circuit_efficient_loss_8x8.png}\tabularnewline
\bottomrule
\end{longtable}
